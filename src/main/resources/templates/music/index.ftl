        ...
        <div class="win10-left">
            ...
            <ul>
                <#list musicList as music>
                    <li data-src="${music.fileSystemName}" data-name="${music.fileName}"><p>${music.fileName}</p><i class="fa fa-play"></i></li>
                </#list>
            </ul>
        </div>
        <div class="win10-right">
            <div id="music">
                <div class="m_play">
                     <#list musicList as music>
                         <#if music_index==0>
                             <div class="m_p_title">${music.fileName}</div>
                         </#if>
                     </#list>
                    <div class="m_p_but">
			...
			<#--[01:36.67]-->
             ...
             <#list musicList as music>
                 <#if music_index==0>
                            <audio src="${music.fileSystemName}" id="myMusic"></audio>
                 </#if>
             </#list>
