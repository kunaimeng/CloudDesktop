...
$.tmUpload = function(options){
	...
	var settings = {
			flash_url : "./static/js/swfupload/upload/swfupload.swf",
...
$.tmUpload.defaults = {
	...
	btnId:"tmupload",//按钮
	btnImage: "./static/js/swfupload/upload/btn_wj.jpg",//对应的上传图标
	btnWidth:100,//图标的宽度
	btnHeight:32,//图标的高度
 ...
 function tm_append_uploaditem(file){
	 ...
	 if(isEmpty(html)){
		 ...
		 "		<span class='fl bar_title'>文件上传</span></span>"+
	 ...
	 "	<div class='load_area'>"+
		 ...
		 "					<span class='loaded' style='display:none'><img src='./static/js/swfupload/upload/loading2.gif'/></span>"+
