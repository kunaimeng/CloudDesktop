...
<head>
    ...
    <script>
        var TIME = {_: +new Date}, newMinotor = 1, So = {
            "comm": {
                "abv": "c",
    ...
    <script>
        (function (e, t, n) {
            var r = e.decodeURIComponent, i = e.location,
                    s = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#039;"},
        ...
        (function (e) {
            function t(e, t) {
                var n = document, r = n.getElementsByTagName("head")[0] || n.documentElement,
            ...
            var a = {
                jquery: {
                    url: "../static/js/wnl/183.js", checker: function () {
                        return !!e.jQuery
                    }
                }, "require.2.1.11": {
                ...
                if (u) {
                    ...
                    function x() {
                        var e = u.getElementsByTagName("A"),
                                t = document.getElementById("mod-engs").getElementsByTagName("A"), n = [], r = "";
...
<div id="main">
    ...
    <ul id="m-result" class="result">
        <li id="first" class="res-list">
            ...
            <script>_loader.use("jquery", function () {
                function l() {
            ...
            <script>
                ...
                _loader.add("rili-widget", "../static/js/wnl/wnl.js");//上述JS文件们已让我压缩成wnl.js
