<html>
<head>
    <title>jQuery虾米音乐播放器样式代码 - 站长素材</title>
    <meta charset="utf-8">

    <link rel="stylesheet" type="text/css" href="./static/css/music/scroll.css">
    <link rel="stylesheet" type="text/css" href="./static/css/music/xiami.css">

    <script type="text/javascript" src="./static/js/jquery-2.2.4.min.js"></script>
    <script type="text/javascript" src="./static/js/music/jquery-ui.js"></script>
    <script type="text/javascript" src="./static/js/music/canvas.js"></script>
    <script type="text/javascript" src="./static/js/music/mousewheel.js"></script>
    <script type="text/javascript" src="./static/js/music/scroll.js"></script>
    <script type="text/javascript" src="./static/js/music/xiami.js"></script>
